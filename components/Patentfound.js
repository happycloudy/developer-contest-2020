...
export default function Patentfound(props){
    ...
    return(
      ...
      <div id="authors" className="text-left"><b>Authors: </b>{props.author1}<br/>{props.author2}</div>
      <div id="Name" className="text-center mt-5"> <h4>НАЗВАНИЕ ПАТЕНТА:{props.patentName} </h4></div>
